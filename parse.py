...
class PARSER:
    ...
    def __ebay_get_list(self, swap, location):
        if swap == 0:
            self.logger.info("#")
    ...
    def __ebay_get_items_in_list(self, page, location, swap):
        ...
        for item in soup.findAll("li", {"class": "ad-listitem"}):
